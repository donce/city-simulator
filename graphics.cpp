...
//#include <gl/glaux.h>//naujas

#include <fstream>//lango dydziui
...
void ReshapeGL (int width, int height)									// Reshape The Window When It's Moved Or Resized
{
	...
	gluPerspective (45.0f, (GLfloat)(width)/(GLfloat)(height),			// Calculate The Aspect Ratio Of The Window
					1.0f, 10000000000000000000000000000.0f);//100	
...
BOOL CreateWindowGL (GL_Window* window)									// This Code Creates Our OpenGL Window
{
	...
	// Make The Rendering Context Our Current Rendering Contextà
...
void ReadWindowSettings(GL_WindowInit &init)
{
	std::ifstream f(c_file_window);
	f >> init.width >> init.height >> init.isFullScreen;
	f.close();
}
